...
public final class Finaldetectposter {
  @NonNull
  ...
  private Finaldetectposter(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "finaldetectposter.tflite", options);
  ...
  @NonNull
  public static Finaldetectposter newInstance(@NonNull Context context) throws IOException {
    return new Finaldetectposter(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Finaldetectposter newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new Finaldetectposter(context, options);
  }
